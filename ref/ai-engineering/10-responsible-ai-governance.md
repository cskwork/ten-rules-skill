# Rule 10 — Govern for Responsible, Documented AI

> 책임 있고 문서화된 AI가 되도록 거버넌스를 세워라.
> Govern for responsible, documented AI.
...
- Document each system with a model card: intended use, out-of-scope use, data, metrics, and known limitations.
- Assess for bias and disparate impact across relevant subgroups, not just aggregate accuracy.
...
- [ ] A model card documents intended use and limitations
- [ ] Bias/fairness is evaluated across subgroups
- [ ] Data governance and PII handling are defined
- [ ] Ownership and an incident path are assigned
